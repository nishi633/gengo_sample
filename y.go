// Code generated by goyacc parser.go. DO NOT EDIT.
...
//line parser.go:32
		{
			yyVAL.num = yyDollar[1].num       // 引数の1つ目を取得
			yylex.(*Lexer).result = yyVAL.num // 計算結果をmain関数に渡すため、Lexer構造体に用意したresultに値を格納。
		}
	case 3:
